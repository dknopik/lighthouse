use std::mem;
use types::{
    BeaconState, BeaconStateError as Error, BeaconStateEip4844, ChainSpec, EthSpec, Fork,
};

/// Transform a `Merge` state into an `Eip4844` state.
pub fn upgrade_to_eip4844<E: EthSpec>(
    ...
    let post = BeaconState::Eip4844(BeaconStateEip4844 {
        ...
        // Execution
        latest_execution_payload_header: mem::take(&mut pre.latest_execution_payload_header),
        // Caches
